        ...
        <>
            {toast.msg ? (
                ...
                <>
                    ...
                    <h2 className="text-xl">Gestión de inventarios</h2>
                    ...
                    <main className="mt-5">
                        {inventario.length > 0 ? (
                            <Grid
                                data={inventario.map((producto) => [
                                    producto.id,
                                    producto.name,
                                    _(
                                        <p
                                            className={`${producto.stock <= 5 ? "text-danger" : "text-success"} font-bold`}
                                        >
                                            {producto.stock}
                                        </p>
                                    ),
