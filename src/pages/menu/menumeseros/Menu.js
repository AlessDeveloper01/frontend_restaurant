...
import SummaryMenu from "./Summary";
...
const PaginaMenuMeseros = () => {
    ...
    useEffect(() => {
        const getMenuItems = async () => {
            const response = await getProductsCategory(categorianame);
